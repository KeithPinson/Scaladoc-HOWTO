 ...
 *
 * Scaladoc displays nicely the class name so why repeat it.  Instead jump
 * right in and say something like, "a class to do something or another"
 *
 * @author <a href="keithpinson.about.me">Keith Pinson</a>
 */
